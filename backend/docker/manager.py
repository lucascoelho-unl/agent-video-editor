    ...
    def get_client(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    return docker.DockerClient(base_url='unix:///Users/lucascoelho/.docker/run/docker.sock')
                except Exception:
                    raise Exception("Cannot connect to Docker daemon. Make sure Docker is running.")
